...
public class TestLauncherApplet extends PApplet {
	
	HubRunner hubRunner;
	
	public void setup() {
		frameRate(10); // Loop to support the GUI events in ControlP5. 10 fps is fast enough to trap user interactions.
